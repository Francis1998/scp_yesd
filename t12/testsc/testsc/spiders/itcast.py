...
class ItcastSpider(scrapy.Spider):
    ...
    start_urls = 'https://github.com/notifications/subscribe'
    ...
    def start_requests(self):
        ...
        data = json.dumps(formdata1)
        yield scrapy.FormRequest(self.start_urls, formdata=formdata1, headers=self.headers, callback=self.parse)
